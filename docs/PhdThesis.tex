...
\subsection*{Flux d'informations dans les modèles mécanistiques de
cancer}\label{flux-dinformations-dans-les-moduxe8les-muxe9canistiques-de-cancer}
\addcontentsline{toc}{subsection}{Flux d'informations dans les modèles
