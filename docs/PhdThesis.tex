...
\caption[Network visualization of *model* thesaurus entries]{\textbf{World map and national rankings of
...
\section{Basic molecular biology of cancer}\label{molecular-biology}

\citep{weinberg2013biology}

\citep{tomasetti2015only}
