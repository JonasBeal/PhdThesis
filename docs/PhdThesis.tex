...
ISMB2020 in Basel but is not published. The example concerning BRAF in
melanomas and colorectal cancers is under revision and the corresponding
pre-print is available as \citet{beal2020personalized}. Finally, the
work on prostate cancer presented in a third section has also been
submitted.
\EndKnitrBlock{summarybox}
...
\subsection{Drug screenings}\label{drug-screenings}
...
\subsection{CRISPR-Cas9 screening}\label{crispr-cas9-screening}
