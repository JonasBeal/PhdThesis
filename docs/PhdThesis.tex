...
\section*{Des modèles logiques personalisés de
cancer}\label{des-moduxe8les-logiques-personalisuxe9s-de-cancer}
\addcontentsline{toc}{section}{Des modèles logiques personalisés de
cancer}
