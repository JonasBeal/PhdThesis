...
software is based on continuous time Markov process applied on a Boolean
state space. The place of this software in the Markovian formalism, and
the associated demonstrations, are available in the original publication
by \citet{stoll2012continuous} and detailed in particular in the related
...
The essence of the formalism is outlined below.
