...
\subtitle{(De la modélisation mécanistique des voies de signalisation dans le
cancer à l'interprétation des modèles et de leurs apports: applications
cliniques et évaluation statistique)}
\date{23/09/2020}
