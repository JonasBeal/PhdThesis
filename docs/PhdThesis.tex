...
logical models to drug investigat}}\label{fig:trials}
\end{figure}
...
\section{Causal inference to leverage
data}\label{causal-inference-to-leverage-data}
...
\chapter{Some statistical evaluations about mechanistic models of
cancer}\label{some-statistical-evaluations-about-mechanistic-models-of-cancer}
...
\section{One step further with
drugs}\label{one-step-further-with-drugs-2}
