...
```{r fey, echo=FALSE, out.width = "90%", fig.cap='(ref:fey-caption)', fig.scap='Mechanistic modeling of JNK pathway and survival of neuroblastima patients, as described by Fey et al.', fig.align='center'}
