...
```{r fey2, echo=FALSE, out.width = "90%", fig.cap='(ref:fey2-caption)', fig.scap='Mechanistic modeling of JNK pathway and survival of neuroblastima patients, as described by Fey \\emph{et al}.', fig.align='center'}
