...
knitr::asis_output('\\epigraph{"Does not the entireness of the complex hint at the perfection of the simple?"}{Edgar Allan Poe (Eureka, 1848)}')
```
...
```{r globocan-map, echo=FALSE, out.width = "100%", fig.cap ='(ref:globocan-map-caption)', fig.scap="World map and national rankings of cancer as a cause of premature death", fig.align='center'}
...
```{r cancer-tissues, echo=FALSE, out.width = "90%", fig.cap ='(ref:cancer-tissues-caption)', fig.scap="Incidence, mortality and survival per cancer types", fig.align='center', fig.show='hold', eval=TRUE, fig.height=6, fig.width=8}
data_incidence <- readr::read_csv("data/cancer/data-incidence.csv") %>%
  ...
  mutate(Cancer=case_when(
    ...
    Cancer=="Non-Hodgkinlymphoma" ~ "Non-Hod. Lymphoma",
...
data_survival <- data_survival[seq(1,nrow(data_survival),2),] %>%
  mutate(Cancer=case_when(
    ...
    Cancer=="Non-Hodgkin Lymphoma" ~ "Non-Hod. Lymphoma",
    TRUE ~ Cancer)) %>%
  filter(Cancer %in% cancer_list) %>%
  mutate(Cancer=factor(Cancer, levels=rev(cancer_list)),
...
```{r central-dogma, echo=FALSE, out.width = "80%", fig.cap ='(ref:central-dogma-caption)', fig.scap="Central dogma of molecular biology", fig.align='center'}
knitr::include_graphics("fig/central-dogma.png")
```
...
```{r hallmarks, echo=FALSE, out.width = "70%", fig.cap ='(ref:hallmarks-caption)', fig.scap="Hallmarks of cancer", fig.align='center'}
knitr::include_graphics("fig/hallmarks.png")
```
...
```{r tcga, echo=FALSE, out.width = "90%", fig.cap ='(ref:tcga-caption)', fig.scap="Genetic alterations frequencies for cancer types from TCGA data", fig.align='center'}
knitr::include_graphics("fig/tcga.jpg")
```
...
```{r circuit, echo=FALSE, out.width = "90%", fig.cap ='(ref:circuit-caption)', fig.scap="Simplistic representation of cellular circuit and pathways", fig.align='center'}
knitr::include_graphics("fig/circuit.jpg")
```
...
```{r pathways, echo=FALSE, out.width = "90%", fig.cap ='(ref:pathways-caption)', fig.scap="Genetic alterations frequencies from TCGA data mapped on a schematic signaling network", fig.align='center'}
knitr::include_graphics("fig/pathways.jpg")
```
