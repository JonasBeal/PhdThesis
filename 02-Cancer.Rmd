...
```{r hallmarks, echo=FALSE, out.width = "90%", fig.cap ='(ref:hallmarks-caption)', fig.scap="Hallmarks of cancer", fig.align='center'}
knitr::include_graphics("fig/hallmarks.jpg")
```
