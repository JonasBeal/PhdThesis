...
```{r cancer-tissues, echo=FALSE, out.width = "90%", fig.cap ='(ref:cancer-tissues-caption)', fig.scap="Incidence, mortility and survival per cancer types", fig.align='center', fig.show='hold', eval=TRUE, fig.height=6, fig.width=8}
