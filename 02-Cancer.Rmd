...
```{r globocan-map, echo=FALSE, out.width = "90%", fig.cap ='(ref:globocan-map-caption)', fig.scap="World map and national rankings of cancer as a cause of premature death", fig.align='center'}
