...
```{r ERG, echo=FALSE, out.width = "40%", fig.cap='(ref:ERG-caption)', fig.scap='Bimodal distribution of ERG gene in TCGA prostate cancer cohort', fig.align='center'}
...
```{r bimodality, echo=FALSE, out.width = "90%", fig.cap='(ref:bimodality-caption)', fig.scap='Bimodality criteria and their combinations', fig.align='center'}
...
```{r PROFILE-CL, echo=FALSE, out.width = "40%", fig.cap='(ref:PROFILE-CL-caption)', fig.scap='Test', fig.align='center'}
...
plot_B <- filter(plot_data_GDSC_noDrug, TCGA_label %in% c('BRCA', 'LUAD', 'COAD/READ')) %>%
