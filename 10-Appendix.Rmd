...
```{r Fumia, echo=FALSE, out.width = "90%", fig.cap='(ref:Fumia-caption)', fig.scap='GINsim representation of the logical model described in Fumia et al. (2013)', fig.align='center'}
...
```{r Verlingue, echo=FALSE, out.width = "90%", fig.cap='(ref:Verlingue-caption)', fig.scap='GINsim representation of the "Verlingue" logical model described in Verlingue et al.', fig.align='center'}
...
```{r Montagud, echo=FALSE, out.width = "90%", fig.cap='(ref:Montagud-caption)', fig.scap='GINsim representation of the "Montagud" logical model of prostate cancer', fig.align='center'}
