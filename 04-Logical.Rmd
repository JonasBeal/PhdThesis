...
knitr::asis_output('\\epigraph{"Je suis l’halluciné de la forêt des Nombres.\n
...
```{r logical, echo=FALSE, out.width = "50%", fig.cap='(ref:logical-caption)', fig.scap='A simple example of a logical model', fig.align='center'}
knitr::include_graphics("fig/logical.png")
```
...
```{r synchronous, echo=FALSE, out.width = "90%", fig.cap='(ref:synchronous-caption)', fig.scap='A simple example of a logical model', fig.align='center'}
knitr::include_graphics("fig/synchronous.png")
```
...
```{r asynchronous, echo=FALSE, out.width = "90%", fig.cap='(ref:asynchronous-caption)', fig.scap='A simple example of a logical model', fig.align='center'}
knitr::include_graphics("fig/asynchronous.png")
```
...
```{r maboss, echo=FALSE, out.width = "100%", fig.cap='(ref:maboss-caption)', fig.scap='Main principles of MaBoSS simulation framework and Gillespie algorithm', fig.align='center'}
knitr::include_graphics("fig/maboss.png")
```
...
The higher level of abstraction of the logical formalism sometimes makes the necessary back and forth between theoretical modeling and experimental or clinical data less easy. Many theoretical approaches have been developed over the years to allow this dialogue at all stages of the modeling cycle (Figure \@ref(fig:cycle)). This section summarizes some of these approaches to show how the use of biological data enriches logical models and brings them closer to clinical applications in precision medicine and in order to better contextualize the original approach presented in the following chapter. 
