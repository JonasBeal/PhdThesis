...
invisible(lapply(X =  c("knitr", "tidyverse", "magrittr",  "ggplot2", "ggpubr", "patchwork", "cowplot", "kableExtra", "ggrepel", "UpSetR", "gghalves", "ggh4x", "latex2exp", "plotly"),
       FUN = require,
       character.only = TRUE))
...
```{r PROFILE-drug, echo=FALSE, out.width = "90%", fig.cap='(ref:PROFILE-drug-caption)', fig.scap='Bimodality criteria and their combinations', fig.align='center'}
...
```{r PROFILE-PCA, echo=FALSE, fig.align='center', fig.cap='(ref:PROFILE-PCA-caption)', fig.scap='PROFILE-generated models and sensitivites to MAP2K1  inhibitors avergaed per cancer type', out.width="90%", fig.height=8, fig.width=8}
...
```{r BRAF-GA, echo=FALSE, out.width = "90%", fig.cap='(ref:BRAF-GA-caption)', fig.scap='BRAF modelling flowchart: from a biological question to validated personalized logical models', fig.align='center'}
...
```{r BRAF-model, echo=FALSE, out.width = "90%", fig.cap='(ref:BRAF-model-caption)', fig.scap='Bimodality criteria and their combinations', fig.align='center'}
...
```{r BRAF-GDSC, echo=FALSE, fig.align='center', fig.cap='(ref:BRAF-GDSC-caption)', fig.scap='Descriptive analysis of cell lines for melanomas and colorectal cancers', out.width="95%", fig.height=5, fig.width=8}
...
plot_A <- upset(plot_data_upset,
      ...
      mainbar.y.label = "Combinations of mutations prevalence",
      queries = list(
...
plot_B <- ggplot(plot_data_BRAF_GDSC, aes(x=TCGA_label, y=Value, fill=TCGA_label)) +
  geom_half_dotplot(binaxis='y',dotsize = 0.8) +
  geom_half_boxplot(alpha=0.8) +
  geom_text(data = plot_data_BRAF_GDSC_label,
            aes(label=paste0("n=", Number), y=y),
            color="black") +
...
plot_Abis <- cowplot::plot_grid(NULL, plot_A$Main_bar, plot_A$Sizes, plot_A$Matrix,
                               nrow=2, align='hv', rel_heights = c(2,1),
                               rel_widths = c(2,3))

(plot_Abis + plot_B) / guide_area() +
...
```{r BRAF-interactive, echo=FALSE, fig.align='center', fig.cap='(ref:BRAF-interactive-caption)', fig.scap='Interactive', out.width="90%", fig.height=5, fig.width=8}
...
```{r BRAF-ML, echo=FALSE, fig.align='center', fig.cap='(ref:BRAF-ML-caption)', fig.scap='Application of personalized models to other CRISPR targets', out.width="90%", fig.height=10, fig.width=8}
