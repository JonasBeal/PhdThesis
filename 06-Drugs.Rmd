...
```
(ref:BRAF-GA-caption) **BRAF modeling flowchart: from a biological question to validated personalized logical models.**
...
```{r BRAF-model, echo=FALSE, out.width = "90%", fig.cap='(ref:BRAF-model-caption)', fig.scap='Logical model of signaling pathways around BRAF in colorectal andmelanoma cancers', fig.align='center'}
