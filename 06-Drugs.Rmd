...
invisible(lapply(X =  c("knitr", "tidyverse", "magrittr",  "ggplot2", "ggpubr", "patchwork", "cowplot", "kableExtra", "ggrepel", "UpSetR", "gghalves", "ggh4x", "latex2exp"),
       FUN = require,
       character.only = TRUE))
...
```{r BRAF-GDSC, echo=FALSE, fig.align='center', fig.cap='(ref:BRAF-GDSC-caption)', fig.scap='Descriptive analysis of cell lines for melanomas and colorectal cancers', out.width="100%", fig.height=5, fig.width=8}
...
```{r BRAF-interactive, echo=FALSE, fig.align='center', fig.cap='(ref:BRAF-interactive-caption)', fig.scap=' Application of personalized models to other CRISPR targets', out.width="90%", fig.height=5, fig.width=8}
...
```
(ref:BRAF-interactive-caption) ** Application of personalized models to other CRISPR targets.** 
