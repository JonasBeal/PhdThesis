...
```{r Shiny2, echo=FALSE, out.width = "90%", fig.cap='(ref:Shiny2-caption)', fig.scap='RShiny interactive application to investigate various simulation scenarios of precision medicine evaluation', fig.align='center'}
