...
```{r causal-struct, echo=FALSE, out.width = "90%", fig.cap='(ref:causal-struct-caption)', fig.scap='Generation and use of simulated data for causal inference', fig.align='center'}
knitr::include_graphics("fig/causal-struct.png")
```
...
if (is_html_output()){
  knitr::include_app('https://jonasbeal.shinyapps.io/application_causal_pm/', height = '600px')
} else {
